...
const ShopifyReports = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          <CardTitle>Select Shopify Client</CardTitle>
          <CardDescription>Choose a client to view their analytics data</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="flex items-center space-x-4">
            ...
            <Button
              ...
              disabled={!selectedClientId || fetchAnalyticsMutation.isPending}
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          <Card>
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium">MTD Net Sales</CardTitle>
